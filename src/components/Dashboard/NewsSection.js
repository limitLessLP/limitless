  ...
  return (
    <div className="mt-8 bg-white shadow-lg rounded-lg p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-900 font-freight">Latest News & Insights</h2>
        ...
        {news.map((item, index) => (
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 font-freight">{item.title}</h3>
