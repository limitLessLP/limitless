        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              <a href="#" className="border-b-2 border-black text-gray-900 inline-flex items-center px-1 pt-1 text-sm font-medium">
                Home
              </a>
              <a href="#" onClick={() => navigate('/portfolio')} className="border-transparent text-gray-500 hover:text-gray-700 inline-flex items-center px-1 pt-1 text-sm font-medium">
                Portfolio
              </a>
