...
const AIAssistant = ({ isOpen, onClose }) => {
  ...
  const handleOptionClick = (option) => {
    ...
    setTimeout(() => {
      let response = {
        type: 'bot',
        content: getResponseForOption(option),
  ...
  const getResponseForOption = (option) => {
    switch(option) {
      case 'What is VC?':
        return "Venture Capital (VC) is a form of private equity financing provided to startups with high growth potential. Through LimitLess, you can invest in premium VC funds.";
      case 'How to Invest':
        return "Investing through LimitLess is straightforward: 1) Complete verification 2) Choose funds 3) Make your investment (min $25k) 4) Monitor your portfolio";
      case 'Risks & Returns':
        return "VC investments can offer high returns but come with risks. Top-quartile VC funds historically show >20% IRR, but investments are illiquid and long-term.";
      default:
        return "Let me help you understand more about that topic...";
    }
  };
