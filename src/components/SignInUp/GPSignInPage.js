        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <div className="space-y-4 mb-8">
            ...
            <p className="text-gray-600">
              Sign in to manage your partnership and fundraising
            </p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-100 to-white p-12 flex-col justify-between">
        <div className="z-10">
          ...
          <p className="text-gray-600 mt-4 max-w-md">
            Sign in to manage your fundraising campaigns, track investor engagement, and access your partnership tools.
          </p>
        </div>
